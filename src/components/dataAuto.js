...
// // localStorage.removeItem( 'favoriteflavor'); // remove item
  ...
  console.log("(index_con[0].index)+1");
                ...
                <div className="AGVControl">
                    ...
                    <div className="panelControl">
                        ...
                        <form onSubmit={onSubmit}>
                            ...
                            <div className="form-group">
                            <label for="exampleInputPassword1" className="label_name" >M/c No.</label>
                            ...
                            <label for="exampleInputPassword1" className="label_name" >Room</label>
                            ...
                            <label for="exampleInputPassword1" className="label_name" >Group</label>
                            <Select className="select"  name="select_prod" placeholder="Product"
                            onChange={(e) => {
                                console.log(e);
                                setProd(e);
                                }}
                            ...
                            <Select className="select" placeholder="Model"
                            onChange={(e) => {
                            console.log(e);
                            setModel(e);
                            }}
                            ...
                            <label for="exampleInputPassword1" className="label_name" >Shift</label>
                            ...
                            <label for="exampleInputPassword1" className="label_name" >Time table</label>
                            ...
                            {showText && <div>
                                <form  >
                                <div>
                                <label for="exampleInputPassword1" className="label_name" >Name :</label>
                                <input
                                    type="name_time"
                                ...
                                <TimePicker class="select-time" format={format} onChange={(time,timeString) => {
                                        console.log(time, timeString);
                            ...
                            <label for="exampleInputPassword1" className="label_name" >Line_no</label>
                            ...
                            <label for="exampleInputPassword1" className="label_name" >Resp_person</label>
                            <input
                                type="resp_person"
                                className="form-control"
                                class="input-control"
                            ...
                            <label for="exampleInputPassword1" className="label_name" >Target</label>
                            <input
                                type="target"
                                className="form-control"
                                class="input-control"
                            ...
                            <label for="exampleInputPassword1" className="label_name" >Start count</label>
                            <input
                                type="st_count"
                                className="form-control"
                                class="input-control"
                            ...
                            <label for="exampleInputPassword1" className="label_name" >Counter</label>
                            <input
                                type="count"
                                className="form-control"
                                class="input-control"
                            ...
                            <label for="exampleInputPassword1" className="label_name" >Take time</label>
                            <input
                                type="take_time"
                                className="form-control"
                                class="input-control"
                            ...
                            <label for="exampleInputPassword1" className="label_name" >Working time</label>
                            <input
                                type="working_time"
                                className="form-control"
                                class="input-control"
